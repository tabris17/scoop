# tabris17 Scoop Bucket

This repository is a custom [Scoop](https://scoop.sh/) bucket for Windows tools and utilities maintained by tabris17.

## Add this bucket

```powershell
scoop bucket add tabris17 https://github.com/tabris17/scoop
```

Then install any app from the bucket:

```powershell
scoop install tabris17/<app-name>
```
...
- GitHub: https://github.com/tabris17/scoop
